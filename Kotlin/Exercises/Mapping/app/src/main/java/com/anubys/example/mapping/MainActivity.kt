...
import com.anubys.example.mapping.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapAdapter = MapsAdapter(this, userMaps, object: OnClickListener{
            override fun onItemClick(position: Int) {
                Log.i("TAG", "Position-Activity: $position")
    ...
    private fun showAlertDialog() {
        ...
        dialog.getButton(DialogInterface.BUTTON_POSITIVE).setOnClickListener {
            val title = mapFormView.findViewById<EditText>(R.id.edtTitle).text.toString()
